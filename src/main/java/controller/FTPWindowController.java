...
public class FTPWindowController implements Initializable {
    ...
    public void setStage(ListView rightList, Button rightUpButton, ListView leftListView) {
        try {
    ...
    public void moveToParentDirectory(Button button, FTPClient ftpClient, ListView listView) {
    ...
    public void changeDirectoryInFTP(ListView list, FTPClient client) {
