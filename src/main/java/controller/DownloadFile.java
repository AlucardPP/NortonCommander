...
/**
 * Created by Alucard on 2016-12-10.
 */
public class DownloadFile {

    public void download(ListView list, String path, FTPClient client)throws IOException {
    ...
    public void upload(FTPClient client,ListView list) throws IOException {
